...
install:
	...
	ppm --no-intro --no-prompt --fix-conflict --install="build/net.intellivoid.accounts_dashboard.ppm"
	rm frontend/index.php; cp make_assets/live.php frontend/index.php;

install_fast:
	rm frontend/index.php; cp make_assets/build.php frontend/index.php;
	ppm --no-intro --no-prompt --fix-conflict --skip-dependencies --install="build/net.intellivoid.accounts_dashboard.ppm"
	rm frontend/index.php; cp make_assets/live.php frontend/index.php;
