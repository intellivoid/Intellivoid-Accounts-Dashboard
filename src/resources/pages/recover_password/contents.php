                            ...
                            <div class="auto-form-wrapper">
                                ...
                                <form action="<?PHP DynamicalWeb::getRoute('recover_password', array('action' => 'submit'), true); ?>" method="POST" id="authentication_form" class="pt-4" name="authentication_form">
                                    <div class="form-group">
                                        ...
                                        <input name="new_password" id="new_password" type="password" autocomplete="new-password" class="form-control" placeholder="New Password" autofocus="autofocus" required>
                                    </div>
