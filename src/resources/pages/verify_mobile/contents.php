                    ...
                    <div class="row w-100 mx-auto animated slideInRight" id="input_dialog">
                        <div class="col-lg-4 mx-auto">
                            <div class="auto-form-wrapper">
                                ...
                                <form action="<?PHP DynamicalWeb::getRoute('verify_mobile', array('action' => 'submit'), true); ?>" method="POST" id="authentication_form" class="pt-4" name="authentication_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text<?PHP if($BorderDanger == true){ HTML::print(" border-danger"); } ?>">
