                            ...
                            <div class="auto-form-wrapper">
                                ...
                                <form action="<?PHP DynamicalWeb::getRoute('verify_mobile', $GetParameters, true); ?>" method="POST" id="authentication_form" class="pt-4" name="authentication_form">
                                    ...
                                    <div class="form-group">
                                        <label for="code" class="label" style="display: none; visibility: hidden;" hidden><?PHP HTML::print(TEXT_VERIFICATION_CODE_LABEL); ?></label>
                                        <input name="code" id="code" autocomplete="off" type="text" class="form-control<?PHP if($BorderDanger == true){ HTML::print(" border-danger"); } ?>" autofocus="autofocus" placeholder="<?PHP HTML::print(TEXT_VERIFICATION_CODE_PLACEHOLDER); ?>" required>
                                    </div>
