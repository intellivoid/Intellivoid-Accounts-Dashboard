                    ...
                    <div class="row w-100 mx-auto animated slideInRight" id="input_dialog">
                        <div class="col-lg-4 mx-auto">
                            <div class="auto-form-wrapper">
                                ...
                                <form action="/verify_mobile?action=submit" method="POST" id="authentication_form" class="pt-4" name="authentication_form">

                                    <div class="form-group">
                                        <label for="code" class="label" style="display: none; visibility: hidden;" hidden>Verification Code</label>
                                        <div class="input-group">
                                            <input name="code" id="code" type="text" class="form-control border-danger" placeholder="Verification Code" required>
