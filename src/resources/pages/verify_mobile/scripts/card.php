            ...
            <div class="card-body pt-0">
                ...
                <form id="authentication_form" name="authentication_form" class="mt-2">
                    <div class="form-group">
                        <label for="code" id="code_label" class="text-muted"><?PHP HTML::print(TEXT_VERIFICATION_CODE_LABEL); ?></label>
                        <div class="position-relative has-icon-left">
                            <input type="text" id="code" class="form-control<?PHP if($BorderDanger == true){ HTML::print(" border-danger"); } ?>" autocomplete="off" name="code" autofocus="autofocus" placeholder="<?PHP HTML::print(TEXT_VERIFICATION_CODE_PLACEHOLDER); ?>" required disabled>
