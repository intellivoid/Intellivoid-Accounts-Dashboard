<?php
    ...
    if(isset($_GET['access_token']))
    {
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('application_error', array('error_code' => '36')));
        }

        if($AccessToken->RequestId !== $AuthenticationRequest->Id)
        {
            Actions::redirect(DynamicalWeb::getRoute('application_error', array('error_code' => '37')));
        }

        if($AccessToken->AccountId !== WEB_ACCOUNT_ID)
        {
            Actions::redirect(DynamicalWeb::getRoute('application_error', array('error_code' => '38')));
        }
