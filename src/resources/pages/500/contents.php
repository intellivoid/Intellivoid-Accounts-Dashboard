                        ...
                        <div class="col-lg-7 mx-auto text-white">
                            <div class="row align-items-center d-flex flex-row">
                                <div class="col-lg-6 text-lg-right pr-lg-4">
                                    <h1 class="display-1 mb-0 animated slow fadeInLeft">500</h1>
                                </div>
                                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                                    <h2 class="animated fadeInDown">OwO</h2>
                                    <h3 class="font-weight-light animated fadeInRight">Server made an oopsy woopsy</h3>
                                </div>
                            </div>
                            <div class="row mt-5">
