...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    function revoke_access(string $access_id)
    {
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('services', array('callback' => '100')));
        }
        catch(Exception $exception)
        {
            Actions::redirect(DynamicalWeb::getRoute('services', array('callback' => '101')));
        }
        ...
        if($ApplicationAccess->Status == ApplicationAccessStatus::Authorized)
        {
            ...
            Actions::redirect(DynamicalWeb::getRoute('services', array('callback' => '102')));
        }

        Actions::redirect(DynamicalWeb::getRoute('services', array('callback' => '103')));
    }
